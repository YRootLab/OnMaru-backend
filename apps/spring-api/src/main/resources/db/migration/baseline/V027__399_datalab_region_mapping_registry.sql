...
CREATE TABLE onmaru.catalog_datalab_region_mappings (
    ...
    CONSTRAINT catalog_datalab_region_mappings_region_id_key UNIQUE (region_id),
    CONSTRAINT catalog_datalab_region_mappings_source_code_key UNIQUE (source_code),
