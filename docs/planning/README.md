...
`work-graph.json`은 최초 W0~W11 범위만 담는다. 새 요구 JX-01~12와 X 후보는 [이슈 영향 문서](journey-exploration/implementation-impact.md)에 있으며 아직 통합·발행되지 않았다. 이 graph만으로 확장 요구까지 처리할 수 있다고 간주하지 않는다.
