...
10. [7일 MVP FE 전달서](seven-day-mvp-fe-handoff.md): 제출 우선순위로 확정한 여정 탐색 중심 범위. 랜딩 전환, 후보3개, 선택 보존형 재탐색, 작은 관계 보기, 카카오 로그인·저장, FE 상태와7일 실행 순서를 정한다. 이번 제출 범위에서는 오디 AI와 multi-agent를 제외한다.
