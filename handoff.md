...
- final audit 재리뷰: URI·domain heuristic이 `Reason: ...`, version, 평점, 거리의 decimal token을 오탐하지 않도록 경계를 좁히고 known URI scheme의 whitespace/newline 우회를 차단했다. focused proposal/eval 86개, FastAPI 전체 148 passed·1 opt-in live smoke skipped, Ruff/mypy, launcher shell test, offline 5 gates·schema/byte 재현성을 통과했다.
