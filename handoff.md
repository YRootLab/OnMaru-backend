...
- 보안 보강: extra field, tool call, URL, HTML, Markdown, control character와 provider가 만든 region ref를 거부한다.
- 검증: proposal adversarial/property-style 27개, FastAPI 전체 Ruff/mypy, pytest 89 passed·1 live smoke skipped를 통과했다.
